export default [
  ...
  },
  {
    ...
    client: "Corespring",
    website: [
      "https://missdemilo-des-12.netlify.com/",
      "https://missdemilo-ca-2064.netlify.com/",
      "https://missdemilo-ca-1666.netlify.com/"
    ],
    github: [
      "https://github.com/venusang/des-12",
      "https://github.com/venusang/ca-2064",
      "https://github.com/venusang/ca-1666"
    ],
    services: [
      "Rapid Prototyping",
      "UI/UX Design",
  ...
  },
  {
    ...
    services: [
      ...
      "Responsive Web",
      "Shopify - Design and Custom Theme Development",
      "UI/UX Design",
      "Web Design",
      "Web Development"
    ],
  ...
  },
  {
    ...
    services: [
      "Web Development, Ember.js (2013), Rapid Prototyping, High Charts"
    ],
  ...
  },
  {
    ...
    screenshots: [
      "d3/D3-general-information-before.png",
      "d3/D3-general-information-after.png",
      "d3/Screenshot-2015-06-23-18.45.18-810x667.png",
  ...
  },
  {
    ...
    services: ["Web Development", "Design", "WordPress"],
    thumbnail: "gtd-logo.png",
    screenshots: ["gtd/gtd-screenshot.jpg"],
    previous: "d3",
    next: "caa"
  },
  {
    ...
    id: "caa",
    title: "CAA",
    client: "Creative Artists Agency (CAA)",
    services: [
      "WordPress",
      ".NET",
      "Marketing Landing Pages",
    ...
    thumbnail: "caa-logo.png",
    screenshots: [
      "caa/CAASpeakers-mock-12-13-2011-homepage-grey.jpg",
      "caa/CAASpeakers-mock-v1a-homepage.jpg",
      "caa/CAASpeakers-wireframe.png",
  ...
  },
  {
    ...
    screenshots: ["ventata/ventata-01.png"],
  ...
  },
  {
    ...
    screenshots: ["rosenlaw/rosen-law-firm.png"],
    previous: "ventata",
    next: "fcci"
  },
  {
    type: "projects",
    id: "fcci",
    title: "First Capitol Consulting Inc.",
    date: "2013",
    client: "First Capitol Consulting Inc.",
    services: [
      "Logo Design",
      "UI/UX Design",
      "Web Design",
    ...
    thumbnail: "fcci-logo.png",
    screenshots: ["fcci/fcci-before.png", "fcci/fcci-after.png"],
    previous: "rosenlaw",
    next: "smart-living-company"
  },
  {
    type: "projects",
    id: "smart-living-company",
    title: "Smart Living Company",
    client: "Smart Living Company",
    services: [
      "E-Commerce",
      "Marketing Landing Pages",
      "UI/UX Design",
    ...
    thumbnail: "slc-logo.png",
    screenshots: [
      "slc/slc-homepage-before-after.png",
  ...
  },
  {
    type: "projects",
    id: "easton-robertson",
    title: "Easton Robertson Insurance",
    client: "Easton Robertson Insurance",
    services: ["Web Development", "UI/UX Design", "Web Design", "WordPress"],
    thumbnail: "easton-robertson-logo.png",
    screenshots: ["eastonrobertson/easton-robertson.png"],
  ...
  },
  {
    ...
    title: "Experian",
    client: "Experian",
    services: ["Web Development", "Web Design", "Email Marketing"],
    thumbnail: "experian-logo.png",
    screenshots: [
      "experian/b2b_final.jpg",
      "experian/BizInsight2008.jpg",
      "experian/BOLv2_final1.jpg",
      "experian/DM-v3.jpg",
  ...
  },
  {
    ...
    title: "Chevy",
    client: "Chevy",
    services: ["Web Design", "Print Design"],
    thumbnail: "chevy-logo.png",
    screenshots: ["chevy/SkiChevy_layout_final.jpg"],
    previous: "experian",
    next: "fox"
  },
  {
  ...
  },
  {
    type: "projects",
    id: "cantinas-ranch",
    title: "Cantinas Ranch",
    client: "Cantinas Ranch",
    services: ["Web Development", "Web Design", "WordPress Development"],
